...
def test_distributed_direct_process_sglang_waits_for_follower_before_leader_ready(
    ...
    _write_runtime_entry(
        ...
        worker_id=1,
        model_instance_id=1,
        deployment_name="distributed-sglang",
        pid=101,
        port=8000,
    ...
    _write_runtime_entry(
        ...
        worker_id=2,
        model_instance_id=1,
        deployment_name="distributed-sglang-follower",
        pid=201,
        port=8001,
...
def test_distributed_direct_process_sglang_subordinate_failure_rolls_back_and_cleans_up(
    monkeypatch, tmp_path: Path
):
    model_instance = make_model_instance()
    assert model_instance.distributed_servers is not None
